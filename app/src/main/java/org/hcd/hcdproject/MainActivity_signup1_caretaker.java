...
public class MainActivity_signup1_caretaker extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_signup1_caretaker);
        ...
        new AlertDialog.Builder(this)
                ...
                .setNegativeButton("홈 화면으로", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Intent intent = new Intent(MainActivity_signup1_caretaker.this, MainActivity_login1.class);
                ...
                .setPositiveButton("활동보조사 선택", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Intent intent = new Intent(MainActivity_signup1_caretaker.this, MainActivity_choosehelper.class);
                        intent.putExtra("VOUCHER_ID", voucher_number);
                        startActivity(intent);
                    }
    ...
    private void initView(){
        ...
        moreInfo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity_signup1_caretaker.this, MainActivity_signup2_caretaker.class);
                intent.putExtra("VOUCHER_ID", voucher_number);
                startActivity(intent);
            }
        });
